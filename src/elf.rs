...
pub struct Writer<'d> {
    ...
    start_p_vaddr: u64,
    file_offset: u64,
    shstr_section: SectionPtr,
    sym_str_section: SectionPtr,
    dyn_sym_str_section: SectionPtr,
    sym_section: SectionPtr,
    dyn_sym_section: SectionPtr,
    got_section: SectionPtr,
    plt_section: SectionPtr,
    got_plt_section: SectionPtr,
